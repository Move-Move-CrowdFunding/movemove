<template>
  <header class="flex items-center justify-between bg-neutral-50">
        ...
        <div class="flex flex-1 items-center justify-end space-x-6">
          ...
          >
            ...
            <BaseButton class="flex h-full flex-shrink-0 items-center justify-center p-2">
              <div
                class="h-6 w-6 flex-shrink-0 bg-neutral-900 [mask-image:url('~/assets/images/close-line.svg')] [mask-position:center] [mask-repeat:no-repeat] [mask-size:contain]"
              ></div>
            </BaseButton>
            <BaseButton
            ...
            >
              <div
                class="bg-neutral-2 h-6 w-6 flex-shrink-0 bg-secondary-2 [mask-image:url('~/assets/images/search.svg')] [mask-position:center] [mask-repeat:no-repeat] [mask-size:contain]"
              ></div>
            </BaseButton>
          </div>
          <div class="flex space-x-4">
            ...
            >
              <div
                class="bg-neutral-2 h-6 w-6 flex-shrink-0 overflow-hidden bg-secondary-2 [mask-image:url('~/assets/images/notifications.svg')] [mask-position:center] [mask-repeat:no-repeat] [mask-size:contain]"
              ></div>
              <div
          ...
          <div class="relative cursor-pointer" @click="toggleMenu">
            <div
              ref="dropdown"
              class="h-10 w-10 overflow-hidden rounded-full bg-[url('https://i.pravatar.cc/150?u=a042581f4e29026704d')] bg-contain bg-center bg-no-repeat"
            ></div>
            <ListMenu
              ref="dropdownMenu"
