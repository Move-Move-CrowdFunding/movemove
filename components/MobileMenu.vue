    ...
    <div class="flex flex-1 flex-col overflow-hidden">
      ...
      <div class="flex flex-1 flex-col overflow-y-auto">
        ...
        <div v-if="isLogin.userData.auth" class="peer bg-neutral-50 peer-[&]:mt-2">
          <UButton
            class="flex flex-shrink-0 items-center space-x-2 rounded-none bg-neutral-50 px-3 py-6 text-base font-normal text-neutral-600 hover:bg-inherit hover:text-secondary-2"
            tag="nuxtLink"
            to="/admin"
            >後台
          </UButton>
        ...
        <div class="bg-neutral-50 peer-[&]:mt-2">
          ...
          <UButton
            v-else
            class="group flex flex-shrink-0 items-center space-x-2 rounded-none bg-neutral-50 px-3 py-6 text-base font-normal text-neutral-600 hover:bg-inherit hover:text-secondary-2"
            tag="nuxtLink"
            to="/"
            @click="logout"
          >
            <div
              class="h-6 w-6 flex-shrink-0 bg-neutral-600 [mask-image:url('~/assets/icons/logout.svg')] [mask-position:center] [mask-repeat:no-repeat] [mask-size:contain] hover:text-secondary-2 group-hover:bg-secondary-2"
            ></div>
            登出
          </UButton>
        </div>
